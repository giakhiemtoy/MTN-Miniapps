...
export async function generateAdCopy(
    ...
    // FIX: Initialize with environment variable instead of passed-in key
    ...
    try {
        ...
        // FIX: Removed API key specific error throwing, fallback will be used for all errors.
    ...
    while (attempts < MAX_RETRIES) {
        ...
        try {
            ...
            if (itemType === 'sitelink') {
             ...
             // FIX: Removed API key specific error throwing
